...
router.get('/shop', cartCounter, async (req, res) => {
  ...
  var prodBrands = await productHelper.fetchProdBrands()
...
router.get('/catFilter/', cartCounter, (req, res) => {

  productHelper.fetchProdsUnderCat(req.query.mainCat).then((products) => {
